export default class FormatUtil {
     ...
     */
    public padWithZero(value: number): string {
     ...
     */
    public parseTime(seconds: number): string {
     ...
     */
    public static placeHolder(string: string, ...placeHolders: any[]): string {
        let index = 0;
     ...
     */
    public static padStart(number: number | string, length: number): string {
     ...
     */
    public static round(number: number, decimals: number = 2): string {
        return Number(
