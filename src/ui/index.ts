...
export { Canceled, FormBody, FormTitle };
...
import Button1 from "./messageform/Button1";
import Button2 from "./messageform/Button2";

export { MessageForm, MessageFormInitializer, Button1, Button2 };
